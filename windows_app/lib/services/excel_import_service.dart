...
class ExcelImportService {
  static Future<void> shareTemplate() async {
    ...
    if (fileBytes != null) {
      ...
      final tempFile = File('${tempDir.path}/template_cashiro.xlsx');
      await tempFile.writeAsBytes(fileBytes);
      
      await Share.shareXFiles(
        [XFile(tempFile.path)],
        subject: 'Template Import Produk Cashiro',
        text: 'Gunakan template ini untuk mengimpor produk secara massal ke aplikasi Cashiro.',
      );
    }
  }
