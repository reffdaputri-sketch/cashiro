...
class BackupService {
  ...
  Future<void> exportDatabase(BuildContext context) async {
    try {
      ...
      final path = join(dbPath, 'cashiro.db');
      ...
      final tempPath = join(tempDir.path, 'cashiro_backup_${DateTime.now().millisecondsSinceEpoch}.db');
      await file.copy(tempPath);

      // Share the file
      final xFile = XFile(tempPath);
      await Share.shareXFiles([xFile], text: 'Backup Database Cashiro');
