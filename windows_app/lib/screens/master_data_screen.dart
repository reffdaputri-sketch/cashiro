...
import 'package:cashiro/screens/product_list_screen.dart';
import 'package:cashiro/screens/customer_list_screen.dart';
import 'package:cashiro/screens/category_list_screen.dart';
import 'package:cashiro/screens/supplier_list_screen.dart';
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          if (auth.hasPermission('Manajemen Produk')) // Reusing permission for simplicity, or we can use 'Data Supplier'
            _buildMenuCard(
              context,
              title: 'Data Supplier',
