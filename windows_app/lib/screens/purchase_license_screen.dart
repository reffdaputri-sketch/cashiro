...
import 'package:cashiro/screens/register_screen.dart';
  ...
  Future<void> _inquiryPayment() async {
    ...
    try {
      ...
      if (mounted && _paymentUrl != null) {
        if (await canLaunchUrlString(_paymentUrl!)) {
          await launchUrlString(_paymentUrl!, mode: LaunchMode.externalApplication);
          ...
          if (mounted) {
            showDialog(
              ...
              builder: (context) => AlertDialog(
                ...
                content: const Text('Silakan selesaikan pembayaran di browser Anda. Jika sudah selesai membayar, silakan klik tombol di bawah ini.'),
                actions: [
                  TextButton(
                    onPressed: () {
