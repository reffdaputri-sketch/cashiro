...
import 'package:cashiro/screens/pos_screen.dart';
            ...
            children: [
              if (activeTabs.isNotEmpty)
                NavigationRail(
                  ...
                  leading: isDesktop ? Container(
                    padding: const EdgeInsets.symmetric(vertical: 24),
                    child: Row(
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: [
                        Icon(Icons.point_of_sale, color: Theme.of(context).primaryColor, size: 32),
                        const SizedBox(width: 8),
                        Text('CASHIRO', style: TextStyle(color: Theme.of(context).primaryColor, fontSize: 24, fontWeight: FontWeight.bold)),
                      ],
                    ),
                  ) : null,
